                ...
                <table>
                    ...
                    <tbody>
                        <!-- code to fetch data from data base siplay in loop -->
                         <?php 
                        $select = "SELECT * FROM maintestrecord WHERE user='$Session_email' ";
                        $query = mysqli_query($conn, $select);
                        ...
                        if ($num > 0) {
                            ...
                            while ($data = mysqli_fetch_assoc($query)) {
                                ...
                                <td data-label='Passage_Name'>$data[passageName]</td>
                                <td data-label='Passage_Time'>$data[passagetime]m</td>
