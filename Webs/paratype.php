...
if (isset($_SESSION['newEmail'])) {
    // echo "Welcome " . $_SESSION['newEmail'];
    $Starter_plan = "5";
    ...
    if ($subscription_status == "on") {
        if ($row['subscription'] == $Starter_plan || $row['subscription'] == $intermediate_plan || $row['subscription'] == $plus_plan) {
            // echo "Subscribed";
        } else {
...
<body>
            ...
            <div class="heading">
                ...
                <div class="middiv">
                    ...
                    <div class="" style="margin-left: 15px;">
                        <label class="switch" >
                            <input type="checkbox" checked id="switch_btn" >
    ...
    <form method="POST" action="paratype.php" name="f1">
...
if (isset($_POST['submit'])) {
    ...
    $insert = "INSERT INTO `single_line_record`(`wpm`, `cpm`, `accuracy`, `error`, `time`,`user`) VALUES ('$wpm','$cpm','$accuracy','$error','$time','$user')";
    // echo $insert;
