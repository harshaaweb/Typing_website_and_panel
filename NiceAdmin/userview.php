              ...
              <table>
                <thead>
                  <tr>
                    ...
                    <th scope="col">ReferBY</th>
                    <th scope="col">ReferBY_Inst</th>
                  </tr>
                </thead>
                <tbody>
                  ...
                  ?>
                      <tr>
                        ...
                        <td data-label="Address"><?php echo $data['address'] ?></td>
                        <td data-label="Email"><?php echo $data['email'] ?></td>
                        <td data-label="ReferenceID"><?php echo $data['referenceID'] ?></td>
                        <td data-label="ReferBY"><?php echo $data['referBY'] ?></td>
                        <td data-label="ReferBY"><?php echo $data['referBY_inst'] ?></td>
                      </tr>
                  <?php
                      $i++;
