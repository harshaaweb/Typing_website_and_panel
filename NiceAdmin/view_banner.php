                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <ul class="auto-grid">
                                ...
                                <?php
                                $select = "SELECT * FROM banner_advertise";
                                $query = mysqli_query($conn, $select);
                                while ($info = mysqli_fetch_assoc($query)) {
                                    $image = $info['banner_image'];
                                    $id = $info['id'];
                                ...
                                ?>
                                    ...
                                    <div class="image-area">
                                        <img src="<?php echo $image; ?>" alt="Preview" class="mt-8  bg-cover">
                                        <a class="remove-image" href="./Deletebanner.php?id=<?php echo $info['id']; ?>" style="display: inline;">&#215;</a>
                                    </div>
