    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><?php echo $data['email']; ?></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              <div class="flex md:w-[300px];">
                <img src="./uploads/<?php echo $data['image']; ?>" alt="Profile"  style="width:100%;">
              </div>
              <h2><?php echo $data['name']; ?></h2>
              <h3><?php echo $role = $data['role']; ?></h3>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <!-- <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Typing World</div>
                  </div> -->

                  <!-- <div class="row">
                    <div class="col-lg-3 col-md-4 label">Job</div>
                    <div class="col-lg-9 col-md-8">Head</div>
                  </div> -->
                  ...
                  <!-- <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">Haryana</div>
                  </div> -->

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Phone</div>
                    <div class="col-lg-9 col-md-8"><?php echo $data['number']; ?></div>
                  </div>
