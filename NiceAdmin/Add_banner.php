...
if (!isset($_SESSION['data'])) {
    ...
    if ($role != 'admin') {
        ...
        if (isset($_POST['submit'])) {
            ...
            $insert = "INSERT INTO `banner_advertise`(`banner_image`) VALUES ('$path')";
            echo $insert;
            ...
            if ($run) {
                ...
                echo "<script>alert('Banner Not Added')
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <button name="submit" class="btn btn-primary">Add Banner</button>
                                    </div>
                                </div>
